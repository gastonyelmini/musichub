package digitalhouse.android.Helpers;
...
public class InternetAsync<T> extends AsyncTask<String, Void, T> {

    private ResultListener<T> listenerControllerCalamardo;
    private Class <T> claseContenedora;

    public InternetAsync(ResultListener<T> listenerControllerCalamardo, Class<T> claseContenedora) {
